...
ROM BYTE configDescriptor1[]={
    ...
    //DESC_CONFIG_WORD(63),   //sizeof(hid_rpt01),      // Size of the report descriptor (MWJ)
    DESC_CONFIG_WORD(104),   //sizeof(hid_rpt01),      // Size of the report descriptor  (MWJ)
    ...
    //DESC_CONFIG_WORD(8),        //size (MWJ)
    DESC_CONFIG_WORD(9),        //size   (MWJ)
    0x01,                        //Interval
...
{'M','W','J',' ','M','e','d','i','a',' ','C','o','n','t','r','o','l','l','e','r'
}};

// (MWJ) Refer to http://www.microchip.com/forums/m618147-print.aspx
// (MWJ) post yts
